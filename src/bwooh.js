...
class bwooh extends React.Component {
  ...
  BS = e => {
    ...
    var ans2 = (fxi - 2 * fxi_1 + fxi_2) / (h * h);
    ans2 = ans2.toFixed(6);
    ...
    var ans3 = (fxi - 3 * fxi_2 + 3 * fxi_1 - fxi_3) / (h * h * h);
    ans3 = ans3.toFixed(6);
    ...
    var ans4 =
      (fxi - 4 * fxi_3 + 6 * fxi_2 - 4 * fxi_1 + fxi_4) / (h * h * h * h);
    ans4 = ans4.toFixed(6);
