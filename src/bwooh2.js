...
class bwooh2 extends React.Component {
  constructor(props) {
    super(props);
  ...
  BS = e => {
    ...
    var ans1 = (3 * fxi - 4 * fxi_1 + fxi_2) / (2 * h);
    ans1 = ans1.toFixed(6);
    ...
    var ans2 = (2 * fxi - 5 * fxi_1 + 4 * fxi_2 - 1 * fxi_3) / (h * h);
    ans2 = ans2.toFixed(6);
    ...
    var ans3 =
      (5 * fxi - 18 * fxi_1 + 24 * fxi_2 - 14 * fxi_3 + 3 * fxi_4) /
      (2 * (h * h * h));
    ans3 = ans3.toFixed(6);
