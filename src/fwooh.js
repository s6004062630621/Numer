...
class fwooh extends React.Component {
  constructor(props) {
    super(props);
  ...
  BS = e => {
    ...
    // x = derivative(derivative(derivative(fx, "x"), "x"), "x").toString();
    // console.log("this is string fx", x);
    cal = derivative(derivative(derivative(fx, "x"), "x"), "x").evaluate({
      x: xi
    });
    fxd_real = parseFloat(cal);
    console.log("this is fxd_real 3:", fxd_real);
    var xi_3 = xi_2 + h;
    cal = evaluate(fx, { x: xi_3 });
    var fxi_3 = parseFloat(cal);
    var ans3 = (fxi_3 - 3 * fxi_2 + 3 * fxi_1 - fxi) / (h * h * h);
    ans3 = ans3.toFixed(6);
    ...
    fxd_real = parseFloat(cal);
    console.log("this is fxd_real 4:", fxd_real);
    var xi_4 = xi_3 + h;
    cal = evaluate(fx, { x: xi_4 });
    var fxi_4 = parseFloat(cal);
    var ans4 =
      (fxi_4 - 4 * fxi_3 + 6 * fxi_2 - 4 * fxi_1 + fxi) / (h * h * h * h);
    ans4 = ans4.toFixed(6);
